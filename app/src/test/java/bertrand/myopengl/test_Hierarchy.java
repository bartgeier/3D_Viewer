...
public class test_Hierarchy {
        ...
        public void attach() {
                ...
                assertEquals(0.0, hierarchy_A.datas.get(2).rotX, 0.001);
        ...
        public void createRoot() {
                ...
                assertEquals(0.0, hierarchy_A.datas.get(0).rotX, 0.001);
                assertEquals(0.0, hierarchy_A.datas.get(0).rotY, 0.001);
                assertEquals(0.0, hierarchy_A.datas.get(0).rotZ, 0.001);
